...
class _ProfileEditScreenState extends State<ProfileEditScreen> {
  ...
  Map<String, List<String>> _timeSlotsByDay = {
    ...
    'Saturday': ["10:00","11:00","12:00","13:00","14:00","15:00","16:00","17:00","18:00","19:00","20:00","21:00","22:00","23:00"],
    'Sunday': ["10:00","11:00","12:00","13:00","14:00","15:00","16:00","17:00","18:00","19:00","20:00","21:00","22:00","23:00"],
  };
  ...
  void _initializeData() {
    if (widget.initialData != null) {
      ...
      _currentProfilePicture = _getFieldValue(data, 'profilePicture', 'pictureUrl');
      if (_currentProfilePicture == 'Not Available' || _currentProfilePicture == 'null') {
  ...
  String _getFieldValue(Map<String, dynamic> data, String key, [String? alternativeKey]) {
  ...
  Future<void> _updateProfile() async {
    ...
    try {
      ...
      final result = await _apiService.updateTherapistProfile(
        ...
        meetLink: _meetLinkController.text.trim().isEmpty ? null : _meetLinkController.text.trim(),
        experience: _experienceController.text.trim().isEmpty ? null : _experienceController.text.trim(),
        expertise: _expertiseController.text.trim().isEmpty ? null : _expertiseController.text.trim(),
        ...
        charge: _chargeController.text.trim().isEmpty ? null : _chargeController.text.trim(),
        availability: backendAvailability.isEmpty ? null : jsonEncode(backendAvailability),
              ...
              Row(
                children: [
                  ...
                  TextButton(
                    ...
                    child: Text('Clear', style: TextStyle(fontSize: 12, color: Colors.red.shade600)),
                  ),
                ],
              ),
            ],
            ...
            children: daySlots.map((timeSlot) {
              ...
              return GestureDetector(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    color: isSelected ? ColorConstants.primaryBrownColor : Colors.white,
                    borderRadius: BorderRadius.circular(20),
                    border: Border.all(
                      color: isSelected ? ColorConstants.primaryBrownColor : Colors.grey.shade300,
                    ),
                  ),
                  child: Text(
                    timeSlot,
      ...
      child: Column(
        children: [
                            ...
                            return Center(
                              child: CircularProgressIndicator(
                                value: loadingProgress.expectedTotalBytes != null
                                    ...
                                    : null,
                                strokeWidth: 2,
                                valueColor: AlwaysStoppedAnimation<Color>(ColorConstants.primaryBrownColor),
                              ),
                            );
                          },
                        )
          ...
          Text(
            ...
            style: TextStyle(
              color: _selectedImage != null ? Colors.blue.shade600 : Colors.grey.shade600,
              fontSize: 14,
